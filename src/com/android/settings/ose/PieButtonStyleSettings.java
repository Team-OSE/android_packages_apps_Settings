...
public class PieButtonStyleSettings extends SettingsPreferenceFragment implements
    ...
    OSESeekBarPreference mPieButtonAlpha;
    OSESeekBarPreference mPieButtonPressedAlpha;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieButtonAlpha =
                (OSESeekBarPreference) findPreference(PREF_PIE_BUTTON_ALPHA);
        mPieButtonAlpha.setOnPreferenceChangeListener(this);

        mPieButtonPressedAlpha =
                (OSESeekBarPreference) findPreference(PREF_PIE_BUTTON_PRESSED_ALPHA);
