...
import com.android.internal.util.ose.ScreenType;

import com.android.settings.ose.ButtonBacklightBrightness;
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    Intent intent =
                            new Intent("com.ose.action.LAUNCH_BLUETOOTH_INPUT_SETTINGS");
                    intent.setClassName("com.ose.settings.device",
                            "com.ose.settings.device.BluetoothInputSettings");
